...
public class Main : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            // начальный геном
            cell.genome.Add(new List<int>() {2, 1, 0, 2, 5, 0, 6, 6, 6, 6, 1, 3, 0, 7, 7, 7, 7, 3, 0, 0 });
            cell.genome.Add(new List<int>() {7} );
            cell.genome.Add(new List<int>() {7} );
            cell.genome.Add(new List<int>() {6} );
            cell.genome.Add(new List<int>() {0} );
            cell.genome.Add(new List<int>() {0} );
            cell.genome.Add(new List<int>() {0} );
        }
    }
